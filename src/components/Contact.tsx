...
import { businessContact } from '../data/branches';
...
export const Contact: React.FC = () => {
  ...
  const infoBlocks = [
    {
      label: 'FOUNDER',
      value: businessContact.founder,
      sub: 'Started the restaurant business in 2011',
      icon: User,
    },
    {
      label: 'ESTABLISHED',
      value: String(businessContact.established),
      sub: 'Taman Satriya, Menggatal, Sabah',
      icon: Calendar,
    },
    {
      label: 'PRIMARY PHONE',
      value: businessContact.phone,
      sub: 'Call or WhatsApp for inquiries',
      isPhone: true,
    ...
    },
    {
      ...
      sub: businessContact.positioning,
      icon: Store,
    },
  ];

  return (
    <section id="contact" className="py-20 lg:py-28 bg-[#F2E8D5] text-[#151515] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {infoBlocks.map((block, idx) => {
            ...
            return (
              <motion.div
                key={idx}
                variants={cornerIn}
                className="card-hover--light bg-[#FFFCFA] p-6 border border-[#C99B3B]/30 flex flex-col justify-between"
              >
                <span className="card-hover__shine" aria-hidden />
                <div className="relative z-[1]">
                  <div className="w-10 h-10 bg-[#063F31] text-[#C99B3B] flex items-center justify-center mb-4 border border-[#C99B3B]/30">
        ...
        <motion.div
          ...
          className="bg-[#1A1510] border border-[#C99B3B] p-8 sm:p-12 text-[#F8F5EC] flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl"
        >
          ...
          <button
            ...
            className="px-8 py-4 bg-[#C99B3B] text-[#1A1510] font-bold text-xs tracking-widest uppercase hover:bg-[#D4AF37] transition-colors flex items-center justify-center space-x-2 shrink-0 shadow-lg"
          >
